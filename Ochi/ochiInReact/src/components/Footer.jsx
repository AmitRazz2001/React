...
function Footer() {
  return (
    <div className='w-full h-screen bg-zinc-900 p-14 flex font-["Founders Grotesk Condensed"]'>
        <div className='w-1/2 h-full flex flex-col justify-between'>
            <div className='heading'>
                <h1 className='text-[14vh] font-bold uppercase leading-none -mb-2'>Eye-</h1>
                <h1 className='text-[14vh] font-bold uppercase leading-none -mb-2'>Opening</h1>
            </div>
            <div className='logo'>
        ...
        <div className='w-1/2 h-full'>
            <h1 className='text-[14vh] font-bold uppercase leading-none -mb-2'>Presentation</h1>
            <div className='social-links mt-10 font-["Neue Montreal"] underline underline-offset-4'>
                ...
                <a href="#" className="block text-xl font-light mt-20">raz.amit2001@gmail.com</a>
            </div>
